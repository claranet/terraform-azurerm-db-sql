...
* **tflint:** 🐛 bump Azure rules version, fix signature bug 527ffc1

### Miscellaneous Chores

* **deps:** 🔗 update mise conf for OpenTofu fe861b8
* **deps:** update dependency opentofu to v1.11.7 a9c2638
* **deps:** update dependency opentofu to v1.12.0 42a5749
* **deps:** update dependency opentofu to v1.12.1 4f4ae27
* **deps:** update dependency opentofu to v1.12.2 cc5af0f
* **deps:** update dependency opentofu to v1.12.3 961ffb6
* **deps:** update dependency opentofu to v1.12.4 867efd0
* **deps:** update dependency terraform-docs to v0.23.0 e1785e4
* **deps:** update dependency terraform-docs to v0.24.0 e229839
* **deps:** update dependency tflint to v0.62.1 3ae5ef7
* **deps:** update dependency tflint to v0.63.1 53f553a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.3.0 a6f5a7a
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.0 62b714e
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.1 6092553
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.4.2 01b6f72
* **deps:** update tools 4993d08
* **pre-commit:** 🔧 move to prek 7ecccd1
* **tfdocs:** bump tfdocs to v0.22 🔧 81cb699

## 8.4.3 (2026-03-27)

### Bug Fixes

* **trivy:** 🐛 drop unsafe trivy pre-commit 🔒️ fc8fb6b

### Code Refactoring

* update module structure and Github actions 👷 0a27d1b

### Miscellaneous Chores

* **AI:** 🤖 add AI Agents instructions for Contributing 59435af
* **deps:** 🔗 bump tflint rules version 7f86172
* **deps:** update dependency opentofu to v1.11.5 779f127
* **deps:** update dependency trivy to v0.69.2 ccf8228
* **deps:** update dependency trivy to v0.69.3 73d4049

## 8.4.2 (2026-02-25)

### Code Refactoring

* **gitlab MR template:** ♻️ update default reviewers group with Azure Factory 🔧 f159291

### Miscellaneous Chores

* **deps:** 🔗 bump tflint rules and example a6fde28
* **deps:** update dependency opentofu to v1.10.7 651f310
* **deps:** update dependency opentofu to v1.11.2 7c55d25
* **deps:** update dependency opentofu to v1.11.3 197463a
* **deps:** update dependency opentofu to v1.11.4 d50d630
* **deps:** update dependency pre-commit to v4.4.0 995d8ee
* **deps:** update dependency pre-commit to v4.5.0 9cb903c
* **deps:** update dependency pre-commit to v4.5.1 c7c5457
* **deps:** update dependency tflint to v0.60.0 c071862
* **deps:** update dependency tflint to v0.61.0 499872c
* **deps:** update dependency trivy to v0.67.1 2518d91
* **deps:** update dependency trivy to v0.67.2 090d66f
* **deps:** update dependency trivy to v0.68.1 c6b80a4
* **deps:** update dependency trivy to v0.68.2 3b8e0c6
* **deps:** update dependency trivy to v0.69.0 b721f68
* **deps:** update dependency trivy to v0.69.1 a79bc67
* **deps:** update pre-commit hook crate-ci/committed to v1.1.10 210d13e
* **deps:** update pre-commit hook crate-ci/committed to v1.1.11 50a515b
* **deps:** update pre-commit hook crate-ci/committed to v1.1.8 ef289eb
* **deps:** update pre-commit hook crate-ci/committed to v1.1.9 5f66ce8
* **deps:** update pre-commit hook tofuutils/pre-commit-opentofu to v2.2.2 62be460
* **deps:** update tools c4376d0

## 8.4.1 (2025-09-30)

### Code Refactoring

* **deps:** 🔗 update claranet/azurecaf to ~> 1.3.0 🔧 00ec186

### Miscellaneous Chores

* **deps:** update dependency opentofu to v1.10.6 cb9ccd5
* **deps:** update dependency tflint to v0.59.1 e5db8cc
* **deps:** update dependency trivy to v0.66.0 18c435f
* **deps:** update dependency trivy to v0.67.0 d39c04c
* **deps:** update terraform claranet/diagnostic-settings/azurerm to ~> 8.2.0 27a697f
