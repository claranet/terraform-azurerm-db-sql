...
| elastic\_pool\_db\_logging | claranet/diagnostic-settings/azurerm | ~> 6.4.1 |
| pool\_logging | claranet/diagnostic-settings/azurerm | ~> 6.4.1 |
| single\_db\_logging | claranet/diagnostic-settings/azurerm | ~> 6.4.1 |
